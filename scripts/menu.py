...
class Credits:
    ...
    def update(self):
        ...
        tools.draw_text(self.menu.main.screen, 'A Game by', 'left', 32, (settings.WIDTH * 5.6 / 10, 0 + self.text_y_offset))
        tools.draw_text(self.menu.main.screen, 'Yash Shinde', 'left', 32, (settings.WIDTH * 5.6 / 10, 32 + self.text_y_offset))
        tools.draw_text(self.menu.main.screen, 'New Athletic M54 font by', 'left', 32, (settings.WIDTH * 5.6 / 10, 90 + self.text_y_offset))
        tools.draw_text(self.menu.main.screen, 'justme54s', 'left', 32, (settings.WIDTH * 5.6 / 10, 122 + self.text_y_offset))
        tools.draw_text(self.menu.main.screen, 'Soundtrack by', 'left', 32, (settings.WIDTH * 5.6 / 10, 180 + self.text_y_offset))
        tools.draw_text(self.menu.main.screen, 'dos88', 'left', 32, (settings.WIDTH * 5.6 / 10, 212 + self.text_y_offset))
        tools.draw_text(self.menu.main.screen, 'Crocodilo Jetpackato', 'left', 32, (settings.WIDTH * 5.6 / 10, 302 + self.text_y_offset))
...
class Shop:
    def __init__(self, menu):
        ...
        self.skin_perry_image = pygame.transform.scale(self.skin_perry_image, (53 * 5, 57 * 5))

        self.skin_blue_image = pygame.image.load('assets/sprites/skins/PlayerFly_Blue.png')
        self.skin_blue_image = pygame.transform.scale(self.skin_blue_image, (53 * 4, 57 * 4))




        self.skins_list = ['Blue', 'Perry']
        self.skins_200 = ['Blue']
    ...
    def draw_skins(self):
        ...
        self.menu.main.screen.blit(self.skin_blue_image, (600, 150))
